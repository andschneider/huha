-- | NOTE: this file is copied directly from https://github.com/Raynes/fsutils
-- The dependencies were too old to be imported using Stack/Cabal, so I wasn't
-- sure what to do exactly. I decided to vendor this into my project.
